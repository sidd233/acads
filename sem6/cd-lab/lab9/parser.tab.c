...
{
       0,   101,   101,   123,   124,   125,   129,   130,   131,   135,
     136,   137
};
#endif
...
#line 1212 "parser.tab.c"
  ...
  case 10: /* F: NUMBER  */
#line 136 "parser.y"
                { char buf[20]; sprintf(buf, "%d", (yyvsp[0].num)); (yyval.node) = createLeaf(buf); }
#line 1218 "parser.tab.c"
    break;

  case 11: /* F: ID  */
#line 137 "parser.y"
                { (yyval.node) = createLeaf((yyvsp[0].id)); free((yyvsp[0].id)); }
